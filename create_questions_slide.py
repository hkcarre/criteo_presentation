"""
Create Beautiful Questions Slide - Senior Designer
Criteo Brand Guidelines + Competitive Intelligence Theme
"""
...
print("🎨 CREATING PROFESSIONAL QUESTIONS SLIDE")
print("="*80)
print("\nAs Senior Designer for Criteo Presentation...")

# ============================================================================
# Step 1: Remove "READY FOR QUESTIONS" from Slide 11
# ============================================================================
print("\n1️⃣ Removing timing text from Slide 11...")

# Find and remove the READY FOR QUESTIONS section
old_questions_html = """                <div style="text-align: center; padding: 100px 0;">
                    <h2 style="color: var(--criteo-orange); font-size: 32px; margin-bottom: 30px;">READY FOR QUESTIONS</h2>
                    <p style="font-size: 18px; color: var(--criteo-gray);">15-20 minute presentation | 10-15 minutes Q&A</p>
                </div>"""

if old_questions_html in html:
    html = html.replace(old_questions_html, '')
    print("  ✓ Removed timing text from Slide 11")
else:
    # Try alternative format
    html = html.replace('READY FOR QUESTIONS', '')
    html = html.replace('15-20 minute presentation | 10-15 minutes Q&A', '')
    print("  ✓ Cleaned up Slide 11")

# ============================================================================
# Step 2: Create Beautiful Questions Slide (Slide 12)
# ============================================================================
print("\n2️⃣ Designing new Questions slide...")

questions_slide_html = """
        <!-- Slide 12: Questions - Beautiful Closing Slide -->
        <div class="slide questions-slide">
            <div class="slide-content" style="display: flex; flex-direction: column; justify-content: center; align-items: center; min-height: 600px; position: relative; overflow: hidden;">
                
                <!-- Abstract Background Pattern -->
                <div style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; opacity: 0.08; z-index: 0;">
                    <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <!-- Network nodes pattern representing competitive intelligence -->
                        <circle cx="10%" cy="20%" r="40" fill="url(#grad1)" opacity="0.3"/>
                        <circle cx="85%" cy="15%" r="60" fill="url(#grad1)" opacity="0.2"/>
                        <circle cx="20%" cy="75%" r="50" fill="url(#grad1)" opacity="0.25"/>
                        <circle cx="90%" cy="80%" r="45" fill="url(#grad1)" opacity="0.3"/>
                        <circle cx="50%" cy="50%" r="80" fill="url(#grad1)" opacity="0.15"/>
                        <circle cx="65%" cy="40%" r="35" fill="url(#grad1)" opacity="0.3"/>
                        <circle cx="30%" cy="45%" r="42" fill="url(#grad1)" opacity="0.25"/>
                        
                        <!-- Connecting lines - network metaphor -->
                        <line x1="10%" y1="20%" x2="50%" y2="50%" stroke="#FF5722" stroke-width="1" opacity="0.2"/>
                        <line x1="85%" y1="15%" x2="50%" y2="50%" stroke="#0066CC" stroke-width="1" opacity="0.2"/>
                        <line x1="20%" y1="75%" x2="50%" y2="50%" stroke="#FF5722" stroke-width="1" opacity="0.2"/>
                        <line x1="90%" y1="80%" x2="50%" y2="50%" stroke="#0066CC" stroke-width="1" opacity="0.2"/>
                    </svg>
                </div>
                ...
                <div style="position: relative; z-index: 1; text-align: center;">
                    ...
                    <div style="margin-bottom: 60px;">
                        <svg width="140px" height="auto" viewBox="0 0 118 24" xmlns="http://www.w3.org/2000/svg">
                            <g fill="#FF5722">
                    ...
                    <!-- Main Title -->
                    <h1 style="font-size: 64px; font-weight: 300; color: var(--criteo-black); margin-bottom: 30px; letter-spacing: -2px;">
                        Questions?
                    </h1>
                    
                    <!-- Divider Line -->
                    <div style="width: 120px; height: 3px; background: linear-gradient(90deg, var(--criteo-orange), var(--criteo-blue)); margin: 40px auto;"></div>
                    
                    <!-- Contact Info -->
                    <div style="margin-top: 60px;">
                        <p style="font-size: 16px; color: var(--criteo-gray); letter-spacing: 1px; text-transform: uppercase; margin-bottom: 10px;">
                            Competitive Intelligence Unit
                        </p>
                        <p style="font-size: 18px; color: var(--criteo-orange); font-weight: 600; margin-bottom: 5px;">
                            Helena Carré
                        </p>
                        <p style="font-size: 14px; color: var(--criteo-gray); letter-spacing: 0.5px;">
                            08/01/2026
                        </p>
                    </div>
                    
                    <!-- Bottom Tagline -->
                    <div style="position: absolute; bottom: 80px; left: 50%; transform: translateX(-50%); text-align: center; width: 100%;">
                        <p style="font-size: 13px; color: var(--criteo-gray-light); letter-spacing: 2px; text-transform: uppercase;">
                            Defending Market Leadership Through Data-Driven Intelligence
                        </p>
                    </div>
...
# Find the closing </div> before </body> and insert new slide
closing_presentation_div = '    </div>\n\n<script>'
if closing_presentation_div in html:
    html = html.replace(closing_presentation_div, questions_slide_html + '\n<script>')
    print("  ✓ Created beautiful Questions slide (Slide 12)")
else:
    print("  ⚠️  Could not find insertion point - trying alternative")
    html = html.replace('</div>\n\n<script>', questions_slide_html + '\n<script>')

# ============================================================================
# Add Questions Slide Specific Styles
# ============================================================================
print("\n3️⃣ Adding Questions slide styles...")

questions_css = """
        /* ========== QUESTIONS SLIDE STYLES ========== */
        ...
        .questions-slide:hover svg {
            transform: scale(1.05);
        }
"""

html = html.replace('    </style>', questions_css + '\n    </style>')
print("  ✓ Added Questions slide animation styles")
...
print("\n" + "="*80)
print("✅ QUESTIONS SLIDE CREATED")
print("="*80)

print("\n🎨 Design Elements:")
print("  ✓ Abstract network pattern (competitive intelligence theme)")
print("  ✓ Criteo orange-to-blue gradient nodes")
print("  ✓ Clean, minimal typography (64px Question?)")
print("  ✓ Professional contact information")
print("  ✓ Elegant gradient divider line")
print("  ✓ Subtle animations (fade-in, scale)")
print("  ✓ Bottom tagline reflecting dataset context")

print("\n✨ Professional Excellence:")
print("  ✓ Criteo brand compliance (colors, logo, typography)")
print("  ✓ Competitive intelligence visual metaphor")
print("  ✓ McKinsey/Bain closing slide standard")
print("  ✓ Beautiful, memorable final impression")

print("\n✅ Presentation now has 12 slides - ready for CEO delivery!")
